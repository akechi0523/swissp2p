...
export default function Buy() {
  ...
  return (
    <>
        <DefaultLayout>
          <div className="pr-16">
            <div className="font-medium text-xl text-primary dark:text-white mb-5">{`${isConfirm? 'Zen Confirmation' : 'Zen Details'}`}</div>
            <div className="flex gap-12">
              <div className="flex flex-col w-1/2 gap-8">
                <Account icon_src1="/images/icon/icon-bank.svg" name="Zen" icon_src2={`${!isConfirm ? "/images/icon/icon-checked2.svg" : "/images/icon/icon-checked.svg"}`}/>
                {/*Payment Details */}
