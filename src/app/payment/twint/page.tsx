    ...
    <>
        <DefaultLayout>
          <div className="md:pr-16">
            <div className="font-medium text-xl text-primary dark:text-white mb-5">{`${isConfirm? 'Twint Confirmation' : 'Twint Details'}`}</div>
            <div className="flex flex-wrap md:flex-nowrap md:gap-12 gap-6">
              <div className="flex flex-col md:w-1/2 w-full md:gap-8 gap-6">
                <Account icon_src1="/images/icon/icon-bank.svg" name="Twint" icon_src2={`${!isConfirm ? "/images/icon/icon-checked2.svg" : "/images/icon/icon-checked.svg"}`}/>
                {/*Payment Details */}
                <div className="bg-white dark:bg-primary rounded-3xl md:px-8 px-4 md:py-6 py-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <PaymentDetailSelect title="Phone Number" placeholder="35464613"/>
                  </div>
                </div>
