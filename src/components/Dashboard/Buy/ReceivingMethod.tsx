  ...
  return (
    <div className="bg-white rounded-3xl px-8 py-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <ReceivingSelect path="#" bgcolor="bg-[#2F80ED]" icon_size={36} icon_src="/images/icon/icon-wallet.svg" content="Wallet Deposit" handleClick={() => handleReceivingSelect("Wallet Deposit")} />
      </div>
    </div>
  );
}
