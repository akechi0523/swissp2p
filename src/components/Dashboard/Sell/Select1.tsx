...
const Select = () => {
	...
	return (
		<div className="bg-white dark:bg-primary rounded-3xl md:px-8 px-4 md:py-6 py-4">
			...
			{path.includes('binance') ? <div className='flex items-center justify-center gap-3 bg-third dark:bg-secondary text-base text-primary dark:text-white font-bold rounded-2xl border-none md:py-3 py-2 mt-4'>
				...
				Binance Pay
			</div> : <div className='flex items-center justify-center gap-3 bg-third dark:bg-secondary text-base text-primary dark:text-white font-bold rounded-2xl border-none md:py-3 py-2 mt-4'>
