...
const LPHeader = (props: {
  ...
  return (
    <>
      ...
      <header className="bg-white flex justify-between items-center md:py-6 py-4 text-nowrap">
        <div className="flex gap-2">
          <button
            ...
            className="block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-primary duration-300 ease-linear md:hidden"
          >
          ...
          <div className="flex lg:gap-16 gap-8">
            <Link className="flex items-center text-xl text-black gap-2 font-medium flex-shrink-0" href="/">
              <Image
                width={24}
                height={32}
        ...
        <div className="flex items-center md:gap-6 gap-2">
          <Link href='/' className="border-none bg-[#04C063] lg:text-base text-sm text-white lg:px-8 px-2 lg:py-3 py-2 rounded-full">Sign up</Link>
          <Link href='/' className="border-none lg:text-base text-sm text-primary">Login</Link>
        </div>
      </header>
    </>
  );
